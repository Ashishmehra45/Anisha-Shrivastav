            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { 
                  ...
                  image: "https://images.unsplash.com/photo-1589829085413-56de8ae18c73?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" // High-quality mics/broadcast vibe
                },
                { 
                  source: "The Sootr", 
                  type: "Feature", 
                  title: "A profile of the Executive Director, MPIDC Gwalior",
                  image: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" // Corporate/Discussion vibe
                },
                { 
                  source: "Haribhoomi", 
                  type: "News report", 
                  title: "On allotment to the Madhya Pradesh cadre",
                  image: "https://images.unsplash.com/photo-1585829365295-ab7cd400c167?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" // Newspaper/Media publishing vibe
                },
              ].map((press, idx) => (
